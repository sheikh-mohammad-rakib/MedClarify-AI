...
* **Strict Anti-Hallucination:** If the text is written in a non-English language that you cannot fully translate, contains heavy cursive shorthand, or is partially obscured, **YOU MUST NOT GUESS.** Do not fill in gaps with generalized medical knowledge, typical dosages, or assumed timelines (e.g., assuming a cream is used "3 times a day" without explicitly reading it).
